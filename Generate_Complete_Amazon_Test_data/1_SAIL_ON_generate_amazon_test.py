...
class GenerateAmazonTestDataSpecificationFile:
    ...
    def generate_specification_file(self):
        csv_header = "protocol,task,test_id,red_light_level,prop_novel,seed,dist_type,difficulty," \
                     ...
                     "class_level_novelty,object_level_novelty,sentiment_level_novelty,interaction_level_novelty".split(",")

        with open("all_NLT_test_specification.csv", mode="w", encoding="utf16") as fout:
            ...
            # (1) novelty type
            for class_level_novelty, object_level_novelty, sentiment_level_novelty, interaction_level_novelty in self.config["novelty_type_list"]:
                # (2)
