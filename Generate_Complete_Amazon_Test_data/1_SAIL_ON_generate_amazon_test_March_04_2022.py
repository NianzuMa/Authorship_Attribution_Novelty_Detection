...
class GenerateAmazonTestDataSpecificationFile:
    ...
    def load_config(self):
        with open("SAIL_ON_amazon_review_config_March_04_2022.yaml", mode="r") as fin:
    ...
    def generate_specification_file(self):
        ...
        with open("all_NLT_test_specification_March_04_2022.csv", mode="w", encoding="utf16") as fout:
            ...
            # (1) novelty type
            for class_level_novelty, object_level_novelty, sentiment_level_novelty, interaction_level_novelty, action_level_novelty in \
                    self.config["novelty_type_list"]:
                # (2)
